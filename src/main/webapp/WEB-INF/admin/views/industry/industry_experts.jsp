...
<table cellpadding="0" cellspacing="0" class="warpper">
   <tr>
      ...
      <td class="right" valign="top">
         ...
         <div class="main">
            <form action="" method=""  id="industry_experts_form">
               ...
               <c:if test="${status.count eq 1 || (status.count-1) % 5 eq 0}">    
                 ...
                 <td><input type="text" name="expertsProportion" id="" class="fany_input w100 ml10"  value="${obj.expertsProportion}"/></td>
...
$(function(){
  ...
  function industrySubmit(){
	  ...
	  var params = $("#industry_experts_form").serialize()+ "&" + token;
      $.ajax({
          type: "POST",
          url: "/admin/industry/save/experts",
          data: params,
