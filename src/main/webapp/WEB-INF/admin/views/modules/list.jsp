      ...
      <div class="inner bg-light lter">
          ...
          <div class="dataTables_wrapper form-inline no-footer">
            <div class="row">
              <br/>
             <div class="col-xs-4">
                            <div id="dataTable_filter" class="dataTables_filter"><label>模板名： <input id="modulesName" type="search" name="modulesName" class="form-control input-sm" aria-controls="dataTable">
            ...
            <table id="staff_table" class="table table-bordered table-striped">
              <thead>
                <th  class="whitecustumer" data-dynatable-column="name">模板名称</th>
                <th  class="whitecustumer" data-dynatable-column="medicineName">药品名称</th>
                <th  class="whitecustumer" data-dynatable-column="created">时间</th>
...
<script>
  $(document).ready(function() {
    ...
    var dynatable = $('#staff_table').dynatable({
      ...
      dataset: {
        ajaxUrl: '/admin/box/modules/list?mac=${mac}'
      },
      writers: {
    ...
    $("#serachCondition").click(function () {
      ...
      if (modulesName == "") {
        dynatable.queries.remove("modulesName");
      } else {
        dynatable.queries.add("modulesName",modulesName);
      }
