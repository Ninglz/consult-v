...
<body>
<input type="hidden" id="activeMenu" value="areaExperts">
...
<script src="/resources/admin/js/areaLevelExperts.js"></script>
...
function citySubmit(){
   ...
   $.ajax({
       type: "POST",
       url: "/admin/area/save/experts?"+params,
       data: {id:id},
       success: function (data) {
     	  if(data="success"){
      		$.dialog({type:2,text:"咨询师地区比例设置成功"});
      	 }else{
      		$.dialog({type:2,text:"咨询师地区比例设置失败"});
      	 }
       }
   },true);
}
