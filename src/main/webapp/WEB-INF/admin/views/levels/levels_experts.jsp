...
<body>
<input type="hidden" id="activeMenu" value="levelsExperts">
         ...
         <div class="main">
            <form action="" method=""  id="leves_form">
               ...
               <c:if test="${status.count eq 1 || (status.count-1) % 5 eq 0}">    
                 ...
                 <td><input type="text" name="levels" id="" class="fany_input w100 ml10" maxlength="4" value="${obj.expertsProportion}"/></td>
...
$(function(){
  ...
  function levelsSubmit(){
      ...
      $.ajax({
          type: "POST",
          url: "/admin/levels/save/experts",
          data: params,
          success: function (data) {
        	  if(data="success"){
        		  $.dialog({type:2,text:"咨询师等级比例设置成功"});
         	 }else{
         		$.dialog({type:2,text:"咨询师等级比例设置失败"});
         	 }
          }
      });
  }
